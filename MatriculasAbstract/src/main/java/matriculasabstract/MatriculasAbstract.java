...
public class MatriculasAbstract {
            ...
            do {
                ...
                switch (comando) {
                    case 1:  // Matricular aluno
                        ...
                        curso.matricular(matriculaAluno, new Aluno(nomeAluno, matriculaAluno));
                        break;
                    case 2: // Cancelar matricula de aluno
                        System.out.println("Digite a matricula do aluno:");
                        curso.listarAlunos();
                        matriculaAluno = scanner.nextLine();
                        curso.cancelarMatricula(matriculaAluno);
                        break;
                    ...
                    case 6: // Remover disciplina
                        ...
                        nomeDisciplina = scanner.nextLine();
                        semestre.cancelarMatricula(nomeDisciplina);
                    case 7: // Matricular aluno em disciplina
                        ...
                        semestre.listarDisciplinas();
                        codigoDisciplina = scanner.nextLine();
                        semestre.getDisciplina(codigoDisciplina).matricular(matriculaAluno, curso.getAluno(matriculaAluno));
                        break;
                    case 8: // Cancelar matricula de aluno em disciplina
                        ...
                        disciplina.cancelarMatricula(matriculaAluno);
